        ...
        <div className="mx-auto w-full max-w-6xl space-y-8">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <Link
                href="/main"
                className="mb-4 inline-flex items-center gap-2 text-sm font-bold text-slate-600 hover:text-blue-600 transition-colors"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
              ...
              <p className="text-slate-500 mt-1">
                จัดการข้อมูลและสิทธิ์การเข้าถึงระบบของผู้ใช้งาน
              </p>
            </div>
            <button
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-slate-100">
                  <thead className="bg-slate-50/50">
                    <tr>
                      <th className="px-8 py-5 text-left text-xs font-bold text-slate-600 uppercase tracking-widest">
                        ผู้ใช้งาน
                      </th>
                      <th className="px-8 py-5 text-left text-xs font-bold text-slate-600 uppercase tracking-widest">
                        บทบาท
                      ...
                      <th className="px-8 py-5 text-right text-xs font-bold text-slate-600 uppercase tracking-widest">
                        จัดการ
                      </th>
                    </tr>
                  </thead>
                      ...
                      >
                        ...
                        <td className="px-8 py-5">
                          <div className="flex items-center gap-2">
                            <span
                              className={`w-2 h-2 rounded-full ${u.is_active ? "bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.5)]" : "bg-slate-300"}`}
                            ></span>
                            <span
                              className={`text-xs font-bold ${u.is_active ? "text-green-600" : "text-slate-400"}`}
                            >
          ...
          <div className="relative w-full max-w-md rounded-[2.5rem] bg-white p-8 shadow-2xl animate-in fade-in zoom-in duration-300">
            <div className="mb-8 text-center">
              ...
              <p className="text-slate-600 font-medium">
                กรอกข้อมูลเพื่อลงทะเบียนผู้ใช้งานเข้าสู่ระบบ
              </p>
            </div>
